package com.woutwoot.jcwows.tools.usefull;/*
    Example:

	new BukkitRunnable()
	{
		com.woutwoot.jcwows.tools.usefull.Scroller scroller = new com.woutwoot.jcwows.tools.usefull.Scroller("&aThis is an &2important &amessage!", 16, 5, '&');
